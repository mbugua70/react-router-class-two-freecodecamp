  ...
  return (
    <>
      ...
      <div className="section">
        ...
        {/* the use of suspend is used in react to suspend some of the react application until something is finshed */}
        <Suspense fallback={<h2>Loading vans ........</h2>}>
          <Await resolve={vansdataPromise.vansdata}>
            {(vansdata) => {
              const displayFilter = typeFilter
                ? vansdata.filter((char) => char.type === typeFilter)
                : vansdata;
                          ...
                          >
                            <div className="vans" key={vansitem.id}>
                              ...
                              <div className="names_price">
                                <div className="van_name">{vansitem.name}</div>
